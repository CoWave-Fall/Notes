...
% 用户可在导言前通过 \providecommand 或 \renewcommand 覆盖。
\@ifundefined{MathNoteReviewStampBase}{%
  \let\MathNoteReviewStampBase\@empty
}{}
\newcommand{\mathnote@reviewstamppathbase}{}
\def\mathnote@reviewstampdircandidates{assest/lzlxV-reviewed,./assest/lzlxV-reviewed,../assest/lzlxV-reviewed,../../assest/lzlxV-reviewed,../../../assest/lzlxV-reviewed,../../../../assest/lzlxV-reviewed}
\@ifundefined{mathnote@rootpath}{}{%
  \edef\mathnote@reviewstampdircandidates{%
    \mathnote@rootpath\detokenize{assest/lzlxV-reviewed},%
    \mathnote@rootpath\detokenize{./assest/lzlxV-reviewed},%
    \mathnote@rootpath\detokenize{../assest/lzlxV-reviewed},%
    \mathnote@rootpath\detokenize{../../assest/lzlxV-reviewed},%
...
% 如果用户显式提供了基路径，则直接使用；否则在候选路径中自动搜索
\ifx\MathNoteReviewStampBase\@empty
  \@for\mathnote@cand:=\mathnote@reviewstampdircandidates\do{%
    \ifmathnote@reviewstampfound\else
      \IfFileExists{\mathnote@cand.pdf}{%
        \edef\mathnote@reviewstamppathbase{\mathnote@cand}%
        \mathnote@reviewstampfoundtrue
      }{%
        \IfFileExists{\mathnote@cand.svg}{%
          \edef\mathnote@reviewstamppathbase{\mathnote@cand}%
          \mathnote@reviewstampfoundtrue
        }{}%
      }%
...
% --------------------------------------------------
\usepackage{geometry}
% �ʼǱ�ʽĬ��ֵ��ͨ�� \MathNoteGeometry �ṩ������ͨ�����µ��ļ��� renew
% �ο� AGENTS.md �еı�ע���Ƽ�ͨ���˽ӿڸ���版式��
\providecommand{\MathNoteGeometry}{%
  a4paper,% ʹ�� geometry �ṩ�ı�׼ֽ��� alias
  top=2.35cm,
  bottom=2.4cm,
  left=2.1cm,
  right=2.1cm,
...
% 中文主字体族：优先思源宋 (Source Han Serif) / 思源黑 (Source Han Sans)，
% 斜体统一使用霞鹜文楷 LXGW WenKai（作为“伪斜体”），
% 若上述字体缺失，则退回 Noto CJK / Fandol 系列。
...
\usepackage{setspace}
\providecommand{\MathNoteLineSpread}{1.15}
\setstretch{\MathNoteLineSpread}
% \setstretch{1.15} % moved to \MathNoteLineSpread for customization
