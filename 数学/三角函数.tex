...
\usepackage{tikz}            % 绘图
\usetikzlibrary{arrows.meta, positioning, intersections, quotes}
\usepackage{geometry}        % 页面边距设置
\usepackage[most]{tcolorbox} % 带颜色的文本框
...
% --- 超链接设置 (解决方案) ---
\usepackage[colorlinks=true, linkcolor=myblue, citecolor=mygreen, urlcolor=myred]{hyperref} % 彩色文字链接，移除方框

% --- 定理、定义、例题环境设置 (移除了 breakable 选项) ---
...
\title{\Huge \bfseries \color{myblue} 三角函数}
\author{Gemini AI}
\date{\today}
\maketitle
