...
% 使用模板提供的主题色重新定义行内强调命令
\newcommand{\highlight}[1]{\textcolor{highlight}{\textbf{#1}}}
\newcommand{\method}[1]{\textcolor{accent}{\textbf{#1}}}
\newcommand{\keypoint}[1]{\textcolor{secondary}{\textbf{#1}}}
\newcommand{\warning}[1]{\textcolor{highlight}{\textbf{注意：#1}}}

% 定理环境：保持传统样式，避免过多彩色文本框
