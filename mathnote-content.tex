...
% Box styles
% --------------------------------------------------
% 颜色覆盖率：仅左侧线条 / 轻度着色 / 较实的色块
\tcbset{
  mathnote coverage/.is choice,
  mathnote coverage/line/.style={colback=surface},
  mathnote coverage/soft/.style={colback=colframe!4!white},
  mathnote coverage/solid/.style={colback=colframe!10!white},
}
...
\newtcolorbox{definitionbox}[2][]{%
  ...
  fonttitle=\sffamily\bfseries\color{secondarytitle},
...
\newtcolorbox{theorembox}[2][]{%
  ...
  fonttitle=\sffamily\bfseries\color{accenttitle},
...
\newtcolorbox{examplebox}[2][]{%
  ...
  fonttitle=\sffamily\bfseries\color{highlighttitle},
...
\newtcolorbox{lemmabox}[2][]{%
  ...
  fonttitle=\sffamily\bfseries\color{inktitle},
...
\newif\ifmathnote@colorlists
\mathnote@colorliststrue

\newcommand{\mathnote@applyliststyle}{%
  \ifmathnote@colorlists
  ...
  \else
    ...
    \setlist[enumerate]{leftmargin=2.1em, itemsep=0.3em, label=\textbf{\arabic*.}}%
  \fi
  \setlist[description]{font=\sffamily\bfseries, labelsep=0.5em}%
}

\newcommand{\MathNoteUseColorLists}{%
  \mathnote@colorliststrue
  \mathnote@applyliststyle
}

\newcommand{\MathNoteUsePlainLists}{%
  \mathnote@colorlistsfalse
  \mathnote@applyliststyle
}

% Ĭ��ʹ�õ�ɫ��б��������б�
\MathNoteUseColorLists
